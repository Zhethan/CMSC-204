...
public class PasswordCheckerTest {
	...
	public void setUp() throws Exception {
		...
		String[] p2 = {"112233AA", "JoeMama321", "robert696999", "4sal#", "coolbeansxdxdxdxd", "EthanYu2", 
				"august30", "abcdef", "Orangeszzz#", "aa11b", "pilotProject", "myPassword", 
				"abCdefg5"};
		passwords2 = new ArrayList<String>();
		passwords2.addAll(Arrays.asList(p2));
		/* ************* STUDENT  ***************
	...
	public void testGetInvalidPasswordsSTUDENT() 
	{
		...
		scan = new Scanner(results.get(1)); //
		assertEquals(scan.next(), "robert696999");
		scan = new Scanner(results.get(3)); //
		assertEquals(scan.next(), "coolbeansxdxdxdxd");
		scan = new Scanner(results.get(5)); //
		assertEquals(scan.next(), "abcdef");
		scan = new Scanner(results.get(6)); //a
		assertEquals(scan.next(), "Orangeszzz#");
	}
}
